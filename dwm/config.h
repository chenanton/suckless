...
static const unsigned int user_bh 	= 18;
...
static const char *fonts[]          = { "Iosevka Custom:size=10:style=extended" };
static const char dmenufont[]       = "Iosevka Custom:size=10:style=extended";
